...
{
    public partial class registerstudentsecond : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            bool c = Int32.TryParse(TextBox1.Text, out int cid);
            string semcode = TextBox2.Text;
            SqlCommand register = new SqlCommand("Procedures_StudentRegisterSecondMakeup", conn);
            register.CommandType = CommandType.StoredProcedure;
            register.Parameters.Add(new SqlParameter("@studentID", Session["user"]));
            register.Parameters.Add(new SqlParameter("@courseID", cid));
            ...
            else
            {
                ...
                checkid.Parameters.Add(new SqlParameter("@courseID", cid));
                conn.Open();
                ...
                {
                    Literal1.Text = "Your are not eligible to take 2nd makeup";
                }
            }
        }
    }
